    ...
    <div className='w-full h-full bg-primary'>
      ...
      >
        ...
        <div className="flex">
          ...
          <button className="bg-secondary border border-border rounded-full h-12 ml-4 px-3 w-sm flex items-center justify-start hover:cursor-pointer hover:bg-background" onClick={() => { SignUpWithGooglePopUp(() => { }) }}>
