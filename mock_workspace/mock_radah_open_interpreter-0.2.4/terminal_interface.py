...
def terminal_interface(interpreter, message, message_queue = None):
    print('')
    print('top of terminal interface')
    # print(message_queue)
    ...
    while True:
        ...
        #     try:
        #         if last_message['role'] == 'assistant' and last_message['type'] == 'message':
        #             # try:
