...
export default function Home({ isSidebarOpen, toggleSidebar, agent, promptRunning, sendMessage, selectedAgent }: HomeInterface) {
        ...
        <div className='w-full h-full flex flex-col items-center justify-start'>
          <div className='w-full h-full flex flex-col items-center justify-start'>
            <div className='h-full flex flex-col items-center justify-start w-[75%]'>
              ...
              <Agent agent={agent} selectedAgent={selectedAgent} />
...
function Agent({ agent, selectedAgent }: { agent: StringAgentUndefined, selectedAgent: string }) {
