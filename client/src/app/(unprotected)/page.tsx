...
export default function Page() {
  ...
  return (
    <div className='w-full h-full bg-primary dark:bg-primary-foreground'>
      ...
      >
        <h1 className='font-extrabold	text-white text-4xl lg:text-6xl'>Benchmarking AI Vision Agents</h1>
        ...
        <div className="flex flex-col items-start gap-4 lg:flex-row lg:gap-0">
          ...
          <button className="bg-primary dark:bg-primary-foreground border border-border rounded-full h-12 lg:ml-4 px-3 w-sm flex items-center justify-start hover:cursor-pointer hover:bg-background" onClick={() => { SignUpWithGooglePopUp(() => { }) }}>
